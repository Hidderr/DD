 ...
 */
public class MyEndMarkerView extends RelativeLayout implements View.OnClickListener {
    Context mContext;
    View mView;
    ...
    public MyEndMarkerView(Context context) {
        super(context);
        mContext = context;
        initView();
    }

    public MyEndMarkerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        initView();
    }

    public MyEndMarkerView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initView() {
        ...
        mView = lay.inflate(R.layout.view_my_end_marker, this);
        mRelativeRoot = (RelativeLayout) mView.findViewById(R.id.relative_my_end_marker_root);
        mTxtStoreName = (TextView) mView.findViewById(R.id.tv_my_end_marker_store_name);
        mImageLocation = (ImageView) mView.findViewById(R.id.image_my_end_marker_location);
        //
