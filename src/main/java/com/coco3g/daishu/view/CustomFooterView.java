...
public class CustomFooterView extends LinearLayout implements IFooterCallBack {
    ...
    private RelativeLayout.LayoutParams progress_lp = null;
...
//        setVisibility(show?VISIBLE:GONE);
    ...
    private void initView(Context context) {
        ...
        //
        progress_lp = new RelativeLayout.LayoutParams(Global.dipTopx(mContext, 25f), Global.dipTopx(mContext, 25f));
        progress_lp.addRule(RelativeLayout.CENTER_HORIZONTAL);
        mProgressBar.setLayoutParams(progress_lp);
    }
